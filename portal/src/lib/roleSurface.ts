...
export const roleSurface: Record<Role, RoleSurfaceConfig> = {
  ...
  // Afgeslankte bestelportal: regie/donaties/planning/voorraad/prognose/
  // rapportages/locaties/integraties zijn voor nu gearchiveerd (uit nav).
  digidromen_staff: {
    kind: "operations",
    homeLabel: "Bestellingen",
