-- Strengere en voorspelbare validatie voor voedingskabel-RMA:
-- - lege strings tellen niet mee als ingevuld
-- - array_length NULL (lege array) wordt als 0 behandeld in de fotocheck
